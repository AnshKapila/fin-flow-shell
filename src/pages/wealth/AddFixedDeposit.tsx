...
import { calculateFDDetails, formatTenure } from "@/lib/fdCalculations";
...
export default function AddFixedDeposit() {
  ...
  return (
    <div className="animate-fade-in min-h-screen bg-background">
      <PageHeader title="Add Fixed Deposit" showBack />
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-3">
              <Input
                ...
                required
              />
              <Select value={tenureUnit} onValueChange={(v) => setTenureUnit(v as "months" | "years")}>
